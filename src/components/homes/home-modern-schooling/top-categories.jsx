...
const TopCategories = () => {
    return (
        <div className="edu-categorie-area categorie-area-4 edu-section-gap">
            ...
            <h2 className="title">כישורי פיתוח</h2>
            <span className="shape-line"><i className="icon-19"></i></span>
            <p>מתכנתיים של המחר</p>
        </div>

                <div className="row g-5">
                <Category delay="50" color="color-primary-style" icon="icon-9" title="ניהול עסקים" course="38" />

                <Category delay="100" color="color-secondary-style" icon="icon-9" icon_class="art-design"
                title="אמנויות ועיצוב" course="40" />

                <Category delay="150" color="color-extra01-style" icon="icon-11" icon_class="personal-development"
                title="פיתוח אישי" course="42" />

                <Category delay="50" color="color-tertiary-style" icon="icon-12" icon_class="health-fitness"
                title="בריאות וכושר" course="36" />

                <Category delay="100" color="color-extra02-style" icon="icon-13" icon_class="data-science"
                title="מדעי הנתונים" course="35" />

                <Category delay="150" color="color-extra03-style" icon="icon-14" title="שיווק" course="28" />

                <Category delay="50" color="color-extra04-style" icon="icon-15" title="עסקים ופיננסים" course="25" />

                <Category delay="100" color="color-extra05-style" icon="icon-16" icon_class="computer-science" title="מדעי המחשב" course="26" />

                <Category delay="150" color="color-extra06-style" icon="icon-17" icon_class="video-photography" title="וידאו וצילום" course="22" />
                </div>
            </div>
        </div>
    )
