...
const HeroArea = () => {
    ...
    return (
        <div className="hero-banner hero-style-8">
            ...
            <h1 className="title" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">מצא את הקורסים <br /> הטובים ביותר לשיפור <br />כישורי הילד שלך</h1>
         <p data-sal-delay="200" data-sal="slide-up" data-sal-duration="1000">למד היום התכוננן למחר</p>
